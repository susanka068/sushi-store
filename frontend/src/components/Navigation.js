...
const Navigation = () => {
    ...
    return (
        <div className="navbar navbar-expand-lg fixed-top navbar-light bg-light shadow-5" style={{ fontFamily: "'Open Sans Condensed', sans-serif", fontSize: "20px" , background:"linear-gradient(to right , #EFF54D, #00AC61)" }}>
            <button className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation">
                <span className="navbar-toggler-icon"></span>
            </button>
            <Link style={{ textDecoration: 'none' }} to='/' ><p className=" ffff nav-link pa2 f3 black" >Sushi-Store</p></Link>
            ...
            <div className="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul className="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li className="nav-item">
                        <Link style={{ textDecoration: 'none' }} to='/newarrivals' > <p className="nav-link">Hot trends</p></Link>
                    </li>
                    <li className="nav-item">
                        <Link style={{ textDecoration: 'none' }} to='/discount' > <p className="nav-link">Discount Store</p></Link>
                    </li>
                    <li className="nav-item">
                        <Link style={{ textDecoration: 'none' }} to='/orders' > <p className="nav-link">Prev Orders</p></Link>
                    </li>
